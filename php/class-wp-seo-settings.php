...
class WP_SEO_Settings {
	...
	protected function setup() {
		...
		if ( is_admin() ) {
			add_action( 'init', array( self::$instance, 'set_properties' ) );
			add_action( 'admin_menu', array( self::$instance, 'add_options_page' ) );
			add_action( 'load-settings_page_' . self::SLUG, array( self::$instance, 'add_help_tab' ) );
	...
	public function add_help_tab() {
		get_current_screen()->add_help_tab( array(
			...
			'callback' => array( self::$instance, 'view_formatting_tags_help_tab' ),
		) );
	}
	...
	public function register_settings() {
		...
		add_settings_field( 'home_title', __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'home', array( 'field' => 'home_title' ) );
		add_settings_field( 'home_description', __( 'Meta Description Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'home', array( 'type' => 'textarea', 'field' => 'home_description' ) );
		add_settings_field( 'home_keywords', __( 'Meta Keywords Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'home', array( 'field' => 'home_keywords' ) );

		add_settings_section( 'post_types', __( 'Post types', 'wp-seo' ), '__return_false', self::SLUG );
		add_settings_field( 'post_types', __( 'Add SEO fields to individual:', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'post_types', array( 'field' => 'post_types', 'type' => 'checkboxes', 'items' => call_user_func_array( 'wp_list_pluck', array( $this->single_post_types, 'label' ) ) ) );
		...
		foreach( $this->single_post_types as $post_type ) {
			...
			add_settings_field( "single_{$post_type->name}_title", __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'single_' . $post_type->name, array( 'field' => "single_{$post_type->name}_title" ) );
			add_settings_field( "single_{$post_type->name}_description", __( 'Meta Description Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'single_' . $post_type->name, array( 'type' => 'textarea', 'field' => "single_{$post_type->name}_description" ) );
			add_settings_field( "single_{$post_type->name}_keywords", __( 'Meta Keywords Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'single_' . $post_type->name, array( 'field' => "single_{$post_type->name}_keywords" ) );
		}
		...
		foreach( $this->archived_post_types as $post_type ) {
			...
			add_settings_field( "archive_{$post_type->name}_title", __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_' . $post_type->name, array( 'field' => "archive_{$post_type->name}_title" ) );
			add_settings_field( "archive_{$post_type->name}_description", __( 'Meta Description Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_' . $post_type->name, array( 'type' => 'textarea', 'field' => "archive_{$post_type->name}_description" ) );
			add_settings_field( "archive_{$post_type->name}_keywords", __( 'Meta Keywords Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_' . $post_type->name, array( 'field' => "archive_{$post_type->name}_keywords" ) );
		}
		...
		foreach( $this->taxonomies as $taxonomy ) {
			...
			add_settings_field( "archive_{$taxonomy->name}_title", __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_' . $taxonomy->name, array( 'field' => "archive_{$taxonomy->name}_title" ) );
			add_settings_field( "archive_{$taxonomy->name}_description", __( 'Meta Description Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_' . $taxonomy->name, array( 'type' => 'textarea', 'field' => "archive_{$taxonomy->name}_description" ) );
			add_settings_field( "archive_{$taxonomy->name}_keywords", __( 'Meta Keywords Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_' . $taxonomy->name, array( 'field' => "archive_{$taxonomy->name}_keywords" ) );
		}

		add_settings_section( 'archive_author', __( 'Author Archives', 'wp-seo' ), array( $this, 'example_author_archive' ), self::SLUG );
		add_settings_field( "archive_author_title", __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_author', array( 'field' => "archive_author_title" ) );
		add_settings_field( "archive_author_description", __( 'Meta Description Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_author', array( 'type' => 'textarea', 'field' => "archive_author_description" ) );
		add_settings_field( "archive_author_keywords", __( 'Meta Keywords Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_author', array( 'field' => "archive_author_keywords" ) );

		add_settings_section( 'archive_date', __( 'Date Archives', 'wp-seo' ), array( $this, 'example_date_archive' ), self::SLUG );
		add_settings_field( "archive_date_title", __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_date', array( 'field' => "archive_date_title" ) );
		add_settings_field( "archive_date_description", __( 'Meta Description Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_date', array( 'type' => 'textarea', 'field' => "archive_date_description" ) );
		add_settings_field( "archive_date_keywords", __( 'Meta Keywords Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'archive_date', array( 'field' => "archive_date_keywords" ) );

		add_settings_section( 'search', __( 'Search Results', 'wp-seo' ), array( $this, 'example_search_page' ), self::SLUG );
		add_settings_field( 'search_title', __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, 'search', array( 'field' => 'search_title' ) );

		add_settings_section( '404', __( '404 Page', 'wp-seo' ), array( $this, 'example_404_page' ), self::SLUG );
		add_settings_field( '404_title', __( 'Title Tag Format', 'wp-seo' ), array( self::$instance, 'field' ), self::SLUG, '404', array( 'field' => '404_title' ) );
	}
